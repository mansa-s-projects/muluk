...
import { pricesFromCents } from "@/lib/pricing-engine";
import RateCardClient from "@/app/dashboard/rate-card/RateCardClient";
...
export default async function PricingPage() {
  ...
  if (rateCardRes.error) {
    console.error("[monetization/pricing] failed to load rate card", rateCardRes.error);
    throw new Error("Failed to load rate card");
  }
  if (creatorStatsRes.error) {
    console.error("[monetization/pricing] failed to load creator stats", creatorStatsRes.error);
