...
const AGENT_PROMPTS: Record<string, string> = {
  researcher: `You are a market research analyst for Mansas Moguls, a creator economy platform disrupting Onlysupporters with 88% creator payouts, anonymous supporter codes, and crypto payment rails to 190 countries.
...
Format as structured bullet points under bold headers. Under 250 words. Be specific and data-driven.`,
  ...
  writer: `You are a senior marketing copywriter for Mansas Moguls — a creator platform where creators keep 88% of earnings.
...
Mansas Moguls's differentiators: anonymous supporter codes, 8% platform fee vs 20% on competitors, crypto payouts to 190 countries. Under 200 words total.`,

  critic: `You are a critical marketing strategist and devil's advocate for Mansas Moguls, a new creator platform.

Identify:
1. Top 3 launch risks in the current go-to-market approach
2. The strongest competitor counter-argument Mansas Moguls must prepare for
3. One critical assumption Mansas Moguls is making that could be wrong
...
• 34% of surveyed OF creators cite platform fees as #1 pain point — Mansas Moguls's 8-12% vs 20% is a decisive wedge
...
Open: creator staring at earnings dashboard, frustrated. Text overlay: "This is what I made." Cut to fee deduction. "This is what they kept." 2-second pause. Cut to Mansas Moguls. "This is what changes Monday."
...
Waitlist numbers are meaningless without day-one creator activation. If Mansas Moguls can't seed 50+ high-earning creators in launch week, the demand flywheel never starts. This is the most underprepared area.

**Risk 3 — Payment Processor Dependency**
Stripe terminates adult content platforms without warning. Mansas Moguls needs 3 independent payment rails operational on launch day.

**Core Assumption at Risk**
Mansas Moguls assumes creators migrate for economics. What they actually migrate for is audience portability. Without a supporter migration tool, switching cost is prohibitively high regardless of fee structure.
