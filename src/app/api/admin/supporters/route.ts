...
// Admin: List subscribed supporters with online/offline presence status
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch paid supporter codes joined to content only.
    ...
    const onlineCount = supporters.filter((f) => f.is_online).length;
